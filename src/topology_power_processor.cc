...
struct _topology_power_processor_t {
...
topology_power_processor_t *
topology_power_processor_new (void)
{
    topology_power_processor_t *self = (topology_power_processor_t *) zmalloc (sizeof (topology_power_processor_t));
    assert (self);
...
topology_power_processor_destroy (topology_power_processor_t **self_p)
{
    assert (self_p);
    if (*self_p) {
        topology_power_processor_t *self = *self_p;
...
topology_power_processor_test (bool verbose)
{
    ...
    topology_power_processor_t *self = topology_power_processor_new ();
    assert (self);
    topology_power_processor_destroy (&self);
    //  @end
    printf ("OK\n");
}
