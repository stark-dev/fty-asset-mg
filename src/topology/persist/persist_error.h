/*  =========================================================================
    topology_power_persist_persist_error - class description
...
#ifndef TOPOLOGY_POWER_PERSIST_PERSIST_ERROR_H_INCLUDED
#define TOPOLOGY_POWER_PERSIST_PERSIST_ERROR_H_INCLUDED
