...
cd "$REPO_DIR/.."
git clone --quiet --depth 1 -b release/IPM_Infra-1.3 https://github.com/42ity/libsodium.git libsodium
git clone --quiet --depth 1 -b release/IPM_Infra-1.3 https://github.com/42ity/libzmq.git libzmq
git clone --quiet --depth 1 -b release/IPM_Infra-1.3 https://github.com/42ity/czmq.git czmq
git clone --quiet --depth 1 -b release/IPM_Infra-1.3 https://github.com/42ity/malamute.git malamute
git clone --quiet --depth 1 -b release/IPM_Infra-1.3 https://github.com/42ity/libmagic.git magic
git clone --quiet --depth 1 -b release/IPM_Infra-1.3 https://github.com/42ity/fty-proto.git fty-proto
git clone --quiet --depth 1 -b release/IPM_Infra-1.3 https://github.com/42ity/cxxtools.git cxxtools
git clone --quiet --depth 1 -b release/IPM_Infra-1.3 https://github.com/42ity/tntdb.git tntdb
cd -
