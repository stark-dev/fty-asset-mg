/*  =========================================================================
    topology_power_shared_asset_general - class description
...
/*
@header
    topology_power_shared_asset_general -
@discuss
@end
*/
     ...
     zhash_t         *extattributesRO)
{
    ...
    auto reply_insert2 = DBAssetsInsert::insert_into_asset_ext_attributes
        (conn, static_cast<uint32_t>(element_id), extattributes, false, err);
    ...
    if(extattributesRO != NULL) {
        ...
        auto reply_insert21 = DBAssetsInsert::insert_into_asset_ext_attributes
            (conn, static_cast<uint32_t>(element_id), extattributesRO, true, err);
    ...
    auto reply_insert3 = DBAssetsInsert::insert_element_into_groups (conn, groups, static_cast<uint32_t>(element_id));
         ...
         ( element_type_id == asset_type::RACK) )
    {
        ...
        auto reply_insert5 = DBAssetsInsert::insert_into_monitor_asset_relation
            (conn, static_cast<uint16_t>(reply_insert4.rowid), static_cast<uint32_t>(reply_insert1.rowid));
        ...
        zhash_t       *extattributesRO)
{
    ...
    for ( auto &one_link: links )
    {
        one_link.dest = static_cast<uint16_t>(element_id);
    }
    ...
    if ( reply_select.status == 1 )
    {
        auto reply_insert6 = DBAssetsInsert::insert_into_monitor_device
            (conn, static_cast<uint16_t>(reply_select.item), element_name);
        ...
        auto reply_insert7 = DBAssetsInsert::insert_into_monitor_asset_relation
            (conn, static_cast<uint16_t>(reply_insert6.rowid), static_cast<uint32_t>(reply_insert1.rowid));
