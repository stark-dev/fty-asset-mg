...
#ifndef TOPOLOGY_DB_TOPOLOGY2_H_INCLUDED
#define TOPOLOGY_DB_TOPOLOGY2_H_INCLUDED
...
struct Item
{
    struct Topology
    {
        ...
        void push_back (const Item &it) {
            int typeId = persist::type_to_typeid (it.type);
            switch (typeId) {
...
// returns TRUE if asset_name is a power device
